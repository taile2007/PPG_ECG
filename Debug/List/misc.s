///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.40.3.8902/W32 for ARM       19/Jul/2016  18:27:34
// Copyright 1999-2015 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        E:\STM32F1\GPIO_ICViet\GPIO_ICViet\Libraries\STM32F10x_StdPeriph_Driver\src\misc.c
//    Command line =  
//        E:\STM32F1\GPIO_ICViet\GPIO_ICViet\Libraries\STM32F10x_StdPeriph_Driver\src\misc.c
...
//    List file    =  E:\STM32F1\GPIO_ICViet\GPIO_ICViet\GPIO\Debug\List\misc.s
//
///////////////////////////////////////////////////////////////////////////////
...
??NVIC_Init_0:
        AND      R0,R3,#0x1F
        LSL      R0,R1,R0
        LDR.N    R1,??DataTable4_4  ;; 0xe000e180
        LSRS     R2,R2,#+5
        STR      R0,[R1, R2, LSL #+2]
        POP      {R4-R7}
          CFI R4 SameValue
