...
//    Endian       =  little
//    Source file  =  
//        E:\STM32F1\GPIO_ICViet\GPIO_ICViet\Libraries\STM32F10x_StdPeriph_Driver\src\stm32f10x_rcc.c
//    Command line =  
//        E:\STM32F1\GPIO_ICViet\GPIO_ICViet\Libraries\STM32F10x_StdPeriph_Driver\src\stm32f10x_rcc.c
...
//    List file    =  
//        E:\STM32F1\GPIO_ICViet\GPIO_ICViet\GPIO\Debug\List\stm32f10x_rcc.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  230   RCC->CR &= (uint32_t)0xFEF6FFFF;
        LDR.N    R2,??DataTable32_2  ;; 0xfef6ffff
        LDR      R1,[R0, #+0]
        ANDS     R1,R2,R1
        STR      R1,[R0, #+0]
//  231 
...
RCC_HSEConfig:
        LDR.N    R1,??DataTable32  ;; 0x40021000
        LDR      R2,[R1, #+0]
        BIC      R2,R2,#0x10000
        STR      R2,[R1, #+0]
...
RCC_HSICmd:
        LDR.N    R1,??DataTable32_3  ;; 0x42420000
        STR      R0,[R1, #+0]
//  359 }
        BX       LR               ;; return
...
//  386   tmpreg = RCC->CFGR;
RCC_PLLConfig:
        LDR.N    R2,??DataTable32_4  ;; 0x40021004
        LDR      R3,[R2, #+0]
...
RCC_PLLCmd:
        LDR.N    R1,??DataTable32_5  ;; 0x42420060
        STR      R0,[R1, #+0]
//  407 }
        BX       LR               ;; return
...
RCC_PREDIV1Config:
        LDR.N    R2,??DataTable32_6  ;; 0x4002102c
...
//  440   RCC->CFGR2 = tmpreg;
        LDR.W    R12,??DataTable32_7  ;; 0xfffefff0
        LDR      R3,[R2, #+0]
        AND      R3,R12,R3
        ORRS     R0,R0,R3
        ORRS     R0,R1,R0
...
//  569   tmpreg = RCC->CFGR;
RCC_SYSCLKConfig:
        LDR.N    R1,??DataTable32_4  ;; 0x40021004
        LDR      R2,[R1, #+0]
...
RCC_GetSYSCLKSource:
        LDR.N    R0,??DataTable32_4  ;; 0x40021004
        LDR      R0,[R0, #+0]
        AND      R0,R0,#0xC
        BX       LR               ;; return
//  590 }
...
RCC_ITConfig:
        LDR.N    R2,??DataTable32_8  ;; 0x40021009
        CMP      R1,#+0
        LDRB     R1,[R2, #+0]
        ITE      NE 
        ORRNE    R0,R0,R1
...
RCC_USBCLKConfig:
        LDR.N    R1,??DataTable32_9  ;; 0x424200d8
        STR      R0,[R1, #+0]
//  734 }
        BX       LR               ;; return
...
RCC_LSEConfig:
        LDR.N    R1,??DataTable32_10  ;; 0x40021020
        MOVS     R2,#+0
        STRB     R2,[R1, #+0]
...
RCC_LSICmd:
        LDR.N    R1,??DataTable32_11  ;; 0x42420480
        STR      R0,[R1, #+0]
//  867 }
        BX       LR               ;; return
...
RCC_RTCCLKCmd:
        LDR.N    R1,??DataTable32_12  ;; 0x4242043c
        STR      R0,[R1, #+0]
//  898 }
        BX       LR               ;; return
...
//  940       if (pllsource == 0x00)
        LSLS     R3,R3,#+15
        IT       PL 
        LDRPL.N  R3,??DataTable32_13  ;; 0x3d0900
...
//  949        RCC_Clocks->SYSCLK_Frequency = (HSE_VALUE / prediv1factor) * pllmull; 
        LDR.N    R4,??DataTable32_14  ;; 0x7a1200
        AND      R3,R3,#0xF
        ADDS     R3,R3,#+1
        UDIV     R3,R4,R3
??RCC_GetClocksFreq_1:
...
??RCC_GetClocksFreq_0:
        LDR.N    R2,??DataTable32_14  ;; 0x7a1200
// 1003       break;
??RCC_GetClocksFreq_2:
        STR      R2,[R0, #+0]
// 1004   }
...
RCC_AHBPeriphClockCmd:
        LDR.N    R2,??DataTable32_16  ;; 0x40021014
        CMP      R1,#+0
        LDR      R1,[R2, #+0]
        ITE      NE 
        ORRNE    R0,R0,R1
...
RCC_APB2PeriphClockCmd:
        LDR.N    R2,??DataTable32_17  ;; 0x40021018
        CMP      R1,#+0
        LDR      R1,[R2, #+0]
        ITE      NE 
        ORRNE    R0,R0,R1
...
RCC_APB1PeriphClockCmd:
        LDR.N    R2,??DataTable32_18  ;; 0x4002101c
        CMP      R1,#+0
        LDR      R1,[R2, #+0]
        ITE      NE 
        ORRNE    R0,R0,R1
...
RCC_APB2PeriphResetCmd:
        LDR.N    R2,??DataTable32_19  ;; 0x4002100c
        CMP      R1,#+0
        LDR      R1,[R2, #+0]
        ITE      NE 
        ORRNE    R0,R0,R1
...
RCC_APB1PeriphResetCmd:
        LDR.N    R2,??DataTable32_20  ;; 0x40021010
        CMP      R1,#+0
        LDR      R1,[R2, #+0]
        ITE      NE 
        ORRNE    R0,R0,R1
...
RCC_BackupResetCmd:
        LDR.N    R1,??DataTable32_21  ;; 0x42420440
        STR      R0,[R1, #+0]
// 1242 }
        BX       LR               ;; return
...
RCC_ClockSecuritySystemCmd:
        LDR.N    R1,??DataTable32_22  ;; 0x4242004c
        STR      R0,[R1, #+0]
// 1255 }
        BX       LR               ;; return
...
RCC_MCOConfig:
        LDR.N    R1,??DataTable32_23  ;; 0x40021007
        STRB     R0,[R1, #+0]
// 1289 }
        BX       LR               ;; return
...
// 1336   if (tmp == 1)               /* The flag to check is in CR register */
        LDR.N    R2,??DataTable32  ;; 0x40021000
        CMP      R1,#+1
        IT       EQ 
        LDREQ    R1,[R2, #+0]
// 1337   {
...
RCC_ClearFlag:
        LDR.N    R0,??DataTable32_24  ;; 0x40021024
        LDR      R1,[R0, #+0]
        ORR      R1,R1,#0x1000000
        STR      R1,[R0, #+0]
// 1375 }
...
RCC_GetITStatus:
        LDR.N    R2,??DataTable32_25  ;; 0x40021008
        LDR      R2,[R2, #+0]
        MOVS     R1,#+0
        TST      R2,R0
        IT       NE 
...
RCC_ClearITPendingBit:
        LDR.N    R1,??DataTable32_26  ;; 0x4002100a
        STRB     R0,[R1, #+0]
// 1456 }
        BX       LR               ;; return
